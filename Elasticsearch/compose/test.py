...
for data in datas:
    result = es.index(index=INDEX, doc_type=DOC_TYPE, body=data, id=data["email"])
...
# print "=====================get====================="
# res = es.get(INDEX, 1, doc_type=DOC_TYPE)
# pprint.pprint(res)
#
# print "=====================get_source====================="
# res = es.get_source(INDEX, 1, doc_type=DOC_TYPE)
# pprint.pprint(res)
# print(type(res))
#
# print "=====================mget====================="
# res = es.mget(index=INDEX, doc_type=DOC_TYPE, body={'ids': [10, 11]})
# pprint.pprint(res)