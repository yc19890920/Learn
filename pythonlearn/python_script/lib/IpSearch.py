...
class IpSearch:
    ...
    def __init__(self):
        try:
            path = os.path.join(os.path.realpath(os.path.split(__file__)[0]), 'qqzeng', 'qqzeng-ip-utf8.dat')
...
if __name__ == "__main__":
    qqzeng = IpSearch()
    result=qqzeng.Find("223.104.11.248")
    result=qqzeng.Find("1.1.128.0")
    # result=qqzeng.Find("192.168.1.200")
    result=qqzeng.Find("113.92.36.39")
    result=qqzeng.Find("106.75.45.75")
    print '------', _get_login_area(result)
    print result
