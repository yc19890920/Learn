...
if __name__ == "__main__":
    ...
    # print rs['subject']
    # print p.parseMailTemplate()

    # print p.get_content()
    from html2text import beautifulsoup_html2text, re_html2tex
    print beautifulsoup_html2text(p.get_content())


    # print rs['attachments']
    # open('/tmp/tmp.html', 'w').write(rs['html_text'])