...
class OrgEmailTemplate(object):
    ...
    def __make_header(self):
        ...
        # self.message['List-Unsubscribe'] = "<mailto:1248644045@qq.com?subject=unsubscribe>, <https://www.bestedm.org/>"
        # self.message['List-Unsubscribe'] = "<mailto:1248644045@qq.com>, <https://www.bestedm.org/>"
        # self.message['List-Unsubscribe'] = "<mailto:1248644045@qq.com>"
        # self.message['List-Unsubscribe'] = "<mailto:1248644045@qq.com>, <https://www.bestedm.org/>"
        # self.message['List-Unsubscribe'] = "https://www.bestedm.org/, mailto:1248644045@qq.com"
        self.message['List-Unsubscribe'] = "<http://www.bestedm.org/login?next=/>, <mailto:1248644045@qq.com?subject=unsubscribe>"
        # self.message['List-Unsubscribe'] = Header("<http://www.bestedm.org/login?next=/>, <mailto:1248644045@qq.com?subject=unsubscribe>", None)
