...
class ParseEmail():
    ...
    def get_attr(self, field, default=None):
        ...
        elif field in ['from', 'sender']: # from, sender
            # 取得原始字符串
            raw_value = self.obj.get(field, None)
            if raw_value is None: return default
...
if __name__ == "__main__":
    email_content = open('test.eml').read()
    ...
    print '------------------------'
    s = p.get_attr('List-Unsubscribe', '')
    print s

    print p.get_attr('List-ID', '')
    print p.get_attr('List-Unsubscribe-Post', '')
    ...
    #
    # print '------------------------'
    # s = p.get_attr('Received', '')
    # print s


    # print '------------------------'
    # s = p.get_attr('X-QQ-FEAT', '')
    # print s
    #
    # print '------------------------'
    # s = p.get_attr('Message-Id', '')
    # print s, type(s)
